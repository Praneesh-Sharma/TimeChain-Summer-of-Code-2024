...
// const signUpResponse = await authModule.signUp({ email: "21052264@kiit.ac.in", password: "Prawns(101)" });
// console.log(signUpResponse);

const loginResponse = await authModule.login({ email: "21052264@kiit.ac.in", password: "Prawns(101)" });
...
// const walletCreation1 = await walletModule.createWallet({ walletName: 'Prawns' });
